...
public class ViewAdapterthree extends BaseAdapter {
	...
	public ViewAdapterthree(Activity a, ArrayList<HashMap<String, String>> d) {
		activity = a;
		data = d;
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		View vi = convertView;
		if (convertView == null)
			vi = inflater.inflate(R.layout.list_row_three, null);
